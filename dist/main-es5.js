(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FishFoodComponent = /** @class */ (function () {
                function FishFoodComponent() {
                }
                Object.defineProperty(FishFoodComponent.prototype, "hideFood", {
                    set: function (value) {
                ...
                FishFoodComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.hide();
                    this.top_pos = 0;
                    this.eventsSubscription = this.events.subscribe(function (f_loc) { return _this.place(f_loc); });
                    this.updateStyles();
                };
                FishFoodComponent.prototype.ngOnDestroy = function () {
                    this.eventsSubscription.unsubscribe();
                };
                FishFoodComponent.prototype.place = function (f_loc) {
                    this.left_pos = f_loc[0];
                    this.top_pos = f_loc[1];
                };
                FishFoodComponent.prototype.hide = function () {
                    this.left_pos = -500;
                };
                FishFoodComponent.prototype.updateStyles = function () {
                    var styles = {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FishComponent = /** @class */ (function () {
                ...
                FishComponent.prototype.ngOnInit = function () {
                    ...
                    this.direction = 1;
                    this.turn = false;
                    this.eventsSubscription = this.events.subscribe(function (f_loc) { return _this.seeFood(f_loc); });
                    this.update();
                };
                FishComponent.prototype.ngOnDestroy = function () {
                    this.eventsSubscription.unsubscribe();
                };
                FishComponent.prototype.determineSize = function () {
                    var size;
                ...
                FishComponent.prototype.seeFood = function (f_loc) {
                    this.target_top = f_loc[1];
                    this.target_left = f_loc[0];
                    var dist = this.targetDistance(this.left_pos, this.top_pos, this.target_left, this.target_top);
                    if (this.fish_type != 10 && dist < 1500) {
                        this.has_target = true;
                    }
                };
                FishComponent.prototype.targetDistance = function (x1, y1, x2, y2) {
                    return Math.sqrt(Math.pow(x1 - x2, 2) + Math.pow(y1 - y2, 2));
                };
                FishComponent.prototype.moveToTarget = function () {
                ...
                FishComponent.prototype.idleMotion = function () {
                ...
                FishComponent.prototype.moveFish = function (vigorous_bool) {
                    if (vigorous_bool) {
                ...
                FishComponent.prototype.update = function () {
                    var _this = this;
                    setInterval(function () {
                        _this.frame_count += 1;
                        if (_this.has_target) { //fish sees food
                            _this.moveToTarget();
                            _this.moveFish(true);
                            var dist = _this.targetDistance(_this.left_pos, _this.top_pos, _this.target_left, _this.target_top);
                            if (dist < 30) {
                                _this.gotFood.emit(true);
                                _this.has_target = false;
                            }
                        }
                        else { //default movement state
                            _this.idleMotion();
                            _this.moveFish(false);
                        }
                    }, 30);
                };
                FishComponent.prototype.turnFish = function () {
                ...
                FishComponent.prototype.updateStyles = function () {
                    var styles = {
                        'left': this.left_pos + "px",
                ...
                FishComponent.prototype.baitFish = function (event) {
                    var x = event.x;
                    var y = event.y;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.isSkyDone = function () {
                    this.sky_done = true;
                };
                HomeComponent.prototype.determineSkyHeight = function () {
                    if (this.width > 1080) {
                        return 700;
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RainDropComponent = /** @class */ (function () {
                ...
                RainDropComponent.prototype.ngOnInit = function () {
                    this.left_pos = this.starting_left;
                    this.top_pos = -100;
                    this.delay = Math.random() * 60;
                    this.update();
                };
                RainDropComponent.prototype.update = function () {
                    var _this = this;
                    var counter = 0;
                    setInterval(function () {
                        if (_this.delay > counter) {
                            counter += 1;
                        }
                        else {
                            if (_this.sky_height > 250) { //sky tall enough for rain
                                if (_this.left_pos > 5) {
                                    _this.left_pos -= 15;
                                }
                                else {
                                    _this.left_pos = _this.starting_left;
                                }
                                if (_this.top_pos < _this.sky_height - 100) { //rain fell to surface
                                    _this.top_pos += 34;
                                }
                                else {
                                    _this.top_pos = 0;
                                    var new_left = Math.floor(Math.random() * 200);
                                    var random_bool = Math.random() >= 0.5;
                                    if (random_bool) {
                                        _this.left_pos = _this.starting_left + new_left;
                                    }
                                    else {
                                        _this.left_pos = _this.starting_left - new_left;
                                    }
                ...
                RainDropComponent.prototype.updateStyles = function () {
                    var styles = {
                        'left': this.left_pos + "px",
                        'top': this.top_pos + "px"
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SkyComponent = /** @class */ (function () {
                ...
                SkyComponent.prototype.ngOnInit = function () {
                    ...
                    var fifth_section = Math.floor(this.sky_width / 5);
                ...
                SkyComponent.prototype.update = function () {
                    var _this = this;
                    setInterval(function () {
                        if (_this.sky_height > _this.starting_height * 0.95) {
                            window.scrollTo(0, 0); //because chrome
                        }
                        if (_this.sky_height > 250) {
                            _this.sky_height -= _this.pool_rate;
                        }
                        else {
                            if (_this.sky_height > 0) {
                                _this.pool_acceleration += 0.08;
                                _this.sky_height -= _this.pool_rate * _this.pool_acceleration;
                            }
                            else {
                                _this.imGone.emit(true);
                            }
                        }
                    }, 60);
                };
                SkyComponent.prototype.updateStyles = function () {
                    var styles = {
                        height: this.sky_height + "px"
                    };
                    return styles;
                };
                SkyComponent.prototype.determinePoolRate = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TankComponent = /** @class */ (function () {
                function TankComponent(document) {
                    this.document = document;
                ...
                TankComponent.prototype.update = function () {
                    var _this = this;
                    setInterval(function () {
                        _this.tank_width = _this.document.getElementById("TANK").offsetWidth;
                    }, 5000);
                };
                TankComponent.prototype.baitFish = function (event) {
                    // var x = event.x;
                    // var y = event.y;
                ...
                TankComponent.prototype.foodEaten = function () {
                    this.food_out = false;
                };
                TankComponent.prototype.decideType = function () {
                ...
                TankComponent.prototype.createFish = function () {
                    this.all_fish = [];
                    var h = this.sky_height;
                    for (var x = 0; x < 3; x++) { //create top cluster
                        var fish = {
                    ...
                    for (var x = 0; x < 3; x++) { //create middle cluster
                        var set_depth = 1050 + Math.floor(Math.random() * 300);
                        var fish = {
                    ...
                    for (var x = 0; x < 8; x++) { //random roaming fish
                        var set_depth = 200 + Math.floor(Math.random() * (this.tank_height - h - 600));
                        var fish = {
                            starting_depth: h + set_depth,
                            starting_left: Math.floor(Math.random() * (this.tank_width - 100) + 50),
                            idle_depth: set_depth,
                ...
                TankComponent.prototype.emitEventToChild = function (x, y) {
                    this.eventsSubject.next([x, y]);
                };
                TankComponent.prototype.openLink = function (link) {
